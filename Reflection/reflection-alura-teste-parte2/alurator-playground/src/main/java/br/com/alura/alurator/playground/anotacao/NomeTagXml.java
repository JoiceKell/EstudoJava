...
@Target({ ElementType.TYPE, ElementType.FIELD })//Onde eu posso utilizar a anotação que está sendo criada, como desejamos utilizar a anotação em amis de um lugar passa-se um array { ElementType.TYPE - quer dizer que pode utilizar a anotação na declaração de uma classe, ElementType.FIELD - no atributo}
